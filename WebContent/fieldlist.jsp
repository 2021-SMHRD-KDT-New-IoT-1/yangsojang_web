                        ...
                        <section>
                           ...
                           <div class="posts">
                              <article>
                                 ...
                                 <p>현장주소</p>
                                 <ul class="actions">
                                    <li><a href="sensorValue.jsp" class="button primary" style="margin-right: 10px;">SAFEBOX 확인</a><a href="fieldUpdate.jsp" class="button" style="margin-right: 10px;">현장 정보 수정</a><a href="safeboxEdit.jsp" class="button">설치 SAFEBOX 목록</a></li>
                                 </ul>
                              </article>
