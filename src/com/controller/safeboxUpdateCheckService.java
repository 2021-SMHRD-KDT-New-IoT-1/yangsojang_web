...
@WebServlet("/safeboxUpdateCheckService")
public class safeboxUpdateCheckService extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(safebox_seq_int>0) {
			System.out.println("기기 수정 페이지 이동 성공!");
			...
			System.out.println("기기 수정 페이지 이동 실패!");
		}
